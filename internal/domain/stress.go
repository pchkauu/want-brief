...
var CheckinKinds = []CheckinKind{CheckinStress, CheckinFocus, CheckinEnergy, CheckinInterest}
...
func ParseCheckinKind(raw string) (CheckinKind, error) {
	...
	switch kind {
	case CheckinStress, CheckinFocus, CheckinEnergy, CheckinInterest:
		return kind, nil
	default:
...
func DefaultLatestCheckins() LatestCheckins {
	return LatestCheckins{Stress: 3, Focus: 3, Energy: 3, Interest: 3}
}
